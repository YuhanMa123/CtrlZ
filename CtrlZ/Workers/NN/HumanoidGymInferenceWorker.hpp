...
namespace z {
/**
 * @brief HumanoidGymInferenceWorker
 * 类型是一个人形机器人推理工人类型，该类实现了HumanoidGym网络兼容的推理功能。
 * @details HumanoidGymInferenceWorker
 * 类型是一个人形机器人推理工人类型，该类实现了HumanoidGym网络兼容的推理功能。
...
class HumanoidGymInferenceWorker
 ...
 public:
   ...
   * @param cfg 配置文件
   */
  HumanoidGymInferenceWorker(SchedulerType::Ptr scheduler,
    ...
    this->InputScaleVec =
        math::cat(clock_scales, this->Scales_command3, this->Scales_dof_pos,
